...
export interface ApiCameraCamera extends Schema.CollectionType {
  ...
  attributes: {
    charateristcs: Attribute.Component<'charateristcs.charateristcs', true>;
...
export interface ApiMainPageMainPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    homeServices: Attribute.Component<'home-services.home-services', true>;
    homeAdvantages: Attribute.Component<
    ...
    aboutItems: Attribute.Component<'home-about-items.home-about-itesm', true>;
    aboutText: Attribute.Text;
    aboutImage: Attribute.Media;
    titleCase: Attribute.String;
    homeCases: Attribute.Component<'home-cases.home-cases', true>;
    qualityTitle: Attribute.String;
    benefitsTitle: Attribute.String;
    homeBenefits: Attribute.Component<'benefits-items.benefits-items', true>;
    qualityItems: Attribute.Component<'home-quality.home-quality', true>;
    blogTitle: Attribute.String;
    homeBlogItems: Attribute.Component<'home-blog-items.home-blog-items', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
